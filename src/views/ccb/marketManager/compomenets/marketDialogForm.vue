  ...
  methods: {
    ...
    async open (id) {
      ...
      if (id) {
        ...
        try {
          const res = await marketApi.getManagementCosts(id)
    ...
    async submitForm () {
      ...
      try {
        ...
        if (data.uniqueAssetCode) {
          ...
          await marketApi.updateManagementCosts(data)
        ...
        // 添加的提交
        await marketApi.createManagementCosts(data)
